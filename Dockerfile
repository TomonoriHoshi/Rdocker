...
RUN R -e "install.packages(c('shiny', 'shinythemes', 'shinydashboard', 'shinycssloaders', 'tidyverse', 'magrittr', 'data.table', 'sf', 'ggrepel', 'ggspatial', 'plotly', 'leaflet', 'mapview', 'DT', 'remotes'), repos='http://cran.rstudio.com/')"
